...
def test_validate():
    ...
    assert validate("busifredeozelyok") == "Güçsüz şifre! Şifreniz en az 1 büyük harf, 1 sayı, ve 1 özel karakter(- _ + # @ $ ! % * ? &) içermelidir."
    ...
    assert validate("Stem_Has_No_Limits_1") == "Şifre onaylandı"